...
def odds_diff(rats,con_ratio,t1,t2):
	difs=[]
...
def odds_ratio(t1,t2):
	...
	return tuple(rats)
def poo_table(t): return [[t[1],t[0]],[t[3],t[2]]]
def pval(t):
	p = ['nan','nan','nan']
	for x in range(0,len(t)):
		if t[x]!='nan': p[x]=scipy.stats.distributions.chi2.sf(t[x],1)
	return tuple(p)
def std_err_calc(a,b,c,d):
